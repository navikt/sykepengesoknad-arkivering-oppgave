...
import no.nav.helse.domain.dto.Arbeidssituasjon.ARBEIDSTAKER
import no.nav.helse.domain.dto.Avsendertype.SYSTEM
import no.nav.helse.domain.dto.Merknad
import no.nav.helse.domain.dto.Soknadstype.*
import no.nav.helse.domain.dto.Sporsmal
import no.nav.helse.domain.dto.Svartype.*
import no.nav.helse.util.DatoUtil.norskDato
import no.nav.helse.util.PeriodeMapper.jsonTilPeriode
import org.slf4j.LoggerFactory
import java.time.LocalDate
import java.util.*
import java.util.Collections.nCopies

val log = LoggerFactory.getLogger("no.nav.helse.service.BeskrivelseService")
