...
class OppgaveServiceTest {
    ...
    fun opprettOppgaveGirFeilmeldingHvisOppgaveErNede() {
        assertThrows(RuntimeException::class.java) {
            ...
            val oppgaveRequest = OppgaveService.lagRequestBody(aktorId, behandlendeEnhet, saksId, journalpostId, lagSoknad(Soknadstype.ARBEIDSTAKERE))
    ...
    fun lagRequestBodyLagerRequestMedRiktigeFelter() {
        val body = OppgaveService.lagRequestBody(aktorId, behandlendeEnhet, saksId, journalpostId, lagSoknad(Soknadstype.ARBEIDSTAKERE))
    ...
    fun lagRequestBodySetterRiktigBehandlingstema() {
        val utland = OppgaveService.lagRequestBody(aktorId, behandlendeEnhet, saksId, journalpostId, lagSoknad(Soknadstype.OPPHOLD_UTLAND))
        val arbeidstaker = OppgaveService.lagRequestBody(aktorId, behandlendeEnhet, saksId, journalpostId, lagSoknad(Soknadstype.ARBEIDSTAKERE))
        val arbeidsledig = OppgaveService.lagRequestBody(aktorId, behandlendeEnhet, saksId, journalpostId, lagSoknad(Soknadstype.ARBEIDSLEDIG))
        val behandlingsdager = OppgaveService.lagRequestBody(aktorId, behandlendeEnhet, saksId, journalpostId, lagSoknad(Soknadstype.BEHANDLINGSDAGER))
        val redusertVenteperiode = OppgaveService.lagRequestBody(aktorId, behandlendeEnhet, saksId, journalpostId, lagSoknad(Soknadstype.SELVSTENDIGE_OG_FRILANSERE), harRedusertVenteperiode = true)
