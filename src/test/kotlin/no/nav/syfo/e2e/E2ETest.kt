...
class E2ETest : AbstractContainerBaseTest() {
    ...
    fun `bømlo sier opprett før vi behandler søknad`() {
        ...
        val oppgave = requireNotNull(oppgaveRepository.findBySykepengesoknadId(søknadsId.toString()))
        ...
        val oppgaveFraAiven = requireNotNull(oppgaveRepository.findBySykepengesoknadId(søknadsId.toString()))
    ...
    fun `bømlo sier utsett så behandler vi søknaden og ikke oppretter oppgave`() {
        ...
        val oppgaveFørJob = requireNotNull(oppgaveRepository.findBySykepengesoknadId(søknadsId.toString()))
        ...
        val oppgaveEtterJob = requireNotNull(oppgaveRepository.findBySykepengesoknadId(søknadsId.toString()))
